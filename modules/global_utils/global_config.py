...
TRAIN_LABELS_CLEAN_ONEHOTINDEX = join(LABELS_FOLDER_PATH, 'train_sent_clean_onehotindex.csv')
DEV_LABELS_CLEAN_ONEHOTINDEX = join(LABELS_FOLDER_PATH, 'dev_sent_clean_onehotindex.csv')
TEST_LABELS_CLEAN_ONEHOTINDEX = join(LABELS_FOLDER_PATH, 'test_sent_clean_onehotindex.csv')
